...
function preload(){
  ...
  obstacle5 = loadImage("assets/c1.png");

  s1 = loadImage("assets/c2.png");
  s2 = loadImage("assets/c3.png");
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(obstaclesGroup.isTouching(trex)||stonesGroup.isTouching(trex)){
        collidedSound.play()
        gameState = END;
    }
  }
